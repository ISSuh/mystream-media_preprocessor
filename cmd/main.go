...
func (producer *MediaProducer) start() {
	producer.muxer.OnPacket = func(pkg []byte) {
	...
	producer.vpid = producer.muxer.AddStream(mpeg2.TS_STREAM_H264)
	producer.apid = producer.muxer.AddStream(mpeg2.TS_STREAM_AAC)
